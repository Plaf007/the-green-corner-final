...
ActiveRecord::Schema[7.0].define(version: 2024_01_17_000029) do
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.decimal "total_virtual_cash", default: "0.0"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "first_name"
    t.string "last_name"
    t.decimal "total_virtual_cash", precision: 10, scale: 2, default: "0.0"
